...
## AugGCL ablation modes added in this version

This repository now supports four experiments:
...
Run the complete Yelp suite with one command:

```bash
bash run_yelp_ablation.sh
```

See [`ABLATION_STUDY.md`](ABLATION_STUDY.md) for the exact objectives, propagation rules, evaluation procedure and output files.
